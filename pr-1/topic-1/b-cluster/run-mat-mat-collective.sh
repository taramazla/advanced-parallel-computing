...
do
    ...
    # Compile with MPI
    mpicc -o matrix_matrix_collective_${size}.o matrix_matrix_collective_${size}.c
...
mpirun --mca btl_tcp_if_exclude docker0,lo -np ${procs} ./matrix_matrix_collective_${size}.o
EOF
